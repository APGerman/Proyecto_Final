...
public class RegistrarAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spregistrar = findViewById(R.id.spregistrar);

        ArrayAdapter<String> adapter = new ArrayAdapter<String>(RegistrarAdminActivity.this, android.R.layout.simple_spinner_item, tipousu);
        adapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spregistrar.setAdapter(adapter);
        ...
        etfechanacimiento.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if(MotionEvent.ACTION_UP == motionEvent.getAction()){
                    DatePickerDialog datePickerDialog = new DatePickerDialog(RegistrarAdminActivity.this, android.R.style.Theme_Holo_Dialog_MinWidth, onDateSetListener, year, month,day);
            ...
            if (ValidarEmail(etmail.getText().toString().trim())) {
                StringRequest stringRequest = new StringRequest(
                    ...
                    public void onResponse(String response) {
                        Toast.makeText(RegistrarAdminActivity.this, response, Toast.LENGTH_SHORT).show();
                    }
                    ...
                    protected Map<String, String> getParams() throws AuthFailureError {
                        ...
                        params.put("tipo", spregistrar.getSelectedItem().toString());
                        return params;
                    }
                };
